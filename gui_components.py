...
class ValidatedNameInput(ctk.CTkFrame):
    def __init__(self, master, theme_color, dir_selector=None, **kwargs):
...
class DirectorySelector(ctk.CTkFrame):
    def __init__(self, master, theme_color,hover_color, **kwargs):
        ...
        self.root_dir_input.bind("<FocusIn>", lambda e:handle_focus_in(self.root_dir_input,self.path_var,self.placeholder))
        self.root_dir_input.bind("<FocusOut>", lambda e:handle_focus_out(self.root_dir_input,self.path_var,self.placeholder))
        ...
        self.remember_button = ctk.CTkCheckBox(self, text='Remember This Directory',
                                               fg_color=theme_color,
                                               hover_color=hover_color,
